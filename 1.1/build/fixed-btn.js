...
KISSY.add('gallery/tsearch/1.1/template',function (S){
    return {
...
KISSY.add('gallery/tsearch/1.1/fixed-btn',function (S,O ,  TripSearch ,Template ,Slide) {
    var WIDTH = 437;
    var HEIGHT = 380;
    var MIN_WIDTH = 152;
    var MIN_HEIGHT = 30;
